      ...
      <div className="pt-4 pb-8 px-6 text-white">
        <div className="pt-2 pb-8 px-6">
          <p className="text-white font-gotham max-w-[625px] text-md mb-12">
            Despite its irresistible allure, Sléj is sadly a purely fictitious festive fragrance,
          ...
          <div className="flex gap-4 lg:gap-8 justify-between flex-col lg:flex-row items-center">
            ...
            <div></div>
            <div className="opacity-90 font-gotham text-sm">
              Copyright © 2025 Proctor and Stevenson Ltd.
            </div>
          </div>
        </div>
      </div>
